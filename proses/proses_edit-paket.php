<?php
    ...
    if ($code === 0) {     
        ...
        if ($ukuran > 2000000) {
            ...
            header("Location:../edit-paket.php?error=$error");
        }
        ...
        if(move_uploaded_file($tmp, $path)) {
            ...
            $sql = "UPDATE paket SET nama_paket ='$nama',harga ='$harga',dekorasi ='$dekorasi',lama ='$lama',Detail ='$detail',foto='$nama_file' WHERE id_paket = '$id'";
